...
from django.conf.global_settings import AUTH_USER_MODEL, LOGIN_REDIRECT_URL, LOGIN_URL, MEDIA_ROOT, MEDIA_URL
...
SECRET_KEY = 'django-insecure-(dbht7c#vn2z@(i)7yhut2a$(6cqh5ig*$1yr=$ennak#y_p($'
